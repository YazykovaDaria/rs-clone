    ...
    <div className="w-full">
      ...
      <div className="w-full p-4 flex justify-between max-h-20">
        <div className="-top-20 w-32 h-32 cursor-pointer flex items-center justify-center transition-colors duration-200 relative mr-3">
          <img
            src="../../../public/icon/unknown-user.svg"
            alt="user"
        ...
        <div>
          <button
            type="submit"
            className="font-bold cursor-pointer px-4 py-1 border rounded-2xl border-1 border-slate-300 border-solid hover:bg-slate-200 transition-colors duration-200"
          >
            Edit profile
          </button>
        </div>
      ...
      <div className="w-full p-4 flex flex-col">
        ...
        <div className="flex flex-row w-full items-start mb-3">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
          ...
          <span className="text-gray-350 ml-1 mr-5">
            Joined {transformDateJoin(registrationDate)}
          </span>
          <svg
          ...
          <span className="text-gray-350 ml-1 mr-5">
            Born {transformDateBirth(birthday)}
          </span>
        </div>
